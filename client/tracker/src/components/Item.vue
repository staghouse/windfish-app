...
v-bind:data-available="isAvailable",
...
export default {
    ...
    data() {
        return {
            imagePath: '../../static/images/sprites/',
            isAvailable: true,
            spriteExtension: '.png',
        };
    },
    computed: {
        item() {
            switch (this.$store.getters.items[this.index].category) {
                case 'chest':
                    this.isAvailable = this.$store.getters.settings.items.showChests.value;
                    break;

                case 'extended':
                    this.isAvailable = this.$store.getters.settings.items.showExtended.value;
                    break;

                case 'super-extended':
                    this.isAvailable = this.$store.getters.settings.items.showSuperExtended.value;
                    break;
